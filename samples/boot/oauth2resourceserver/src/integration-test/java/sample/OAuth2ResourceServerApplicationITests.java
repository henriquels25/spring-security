...
public class OAuth2ResourceServerApplicationITests {
	...
	@Test
	public void performGetWhenValidBearerTokenThenScopedRequestsAlsoWork()
			throws Exception {
	...
	@Test
	public void performGetWhenInsufficientlyScopedBearerTokenThenDeniesScopedMethodAccess()
			throws Exception {
